# How to Contribute to 大圣之怒

Thanks for your interest in contributing to 大圣之怒! Your help makes this project better. This guide explains how to contribute effectively.

大圣之怒 is a modern AI chat application with advanced search capabilities.

## Project Structure

大圣之怒's codebase is organized as follows:
...
- **UI Components and Pages**:
  ...
  - **API Routes (`src/app/api`)**: API endpoints implemented with Next.js API routes.
    ...
    - `/api/search`: Provides direct access to 大圣之怒's search capabilities.
...
大圣之怒 exposes several API endpoints for programmatic access, including:

- **Search API**: Access 大圣之怒's advanced search capabilities directly via the `/api/search` endpoint. For detailed documentation, see `docs/api/search.md`.
...
Following these steps will help maintain the integrity of 大圣之怒's codebase and facilitate a smoother integration of your valuable contributions. Thank you for your support and commitment to improving 大圣之怒.
